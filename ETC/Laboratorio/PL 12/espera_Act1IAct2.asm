...
#ANDREU:
# El lw seguent posa el bit R a 0 per a que torne a esperar
#Si el comente i execute possara sempre "Esperando... Fin" sense tindre que polsar res.	
#Per a reiniciar la R nomes fa falta una lectura, aixi que ens val el lw.
	lw $t2,4($t0)
