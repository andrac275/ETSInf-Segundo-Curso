...
public class ABB<E extends Comparable<E>> {
    ...
    public ABB(E[] v) {        
        // COMPLETAR
        //Ordena l'array que passem. 
        Ordenacion.mergeSort1(v);
        //Possar l'arrel del arbre.
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        ...
        //Trobar l'element del mig del array
        int meitat = (ini + fin) / 2;
        
        //Extreure els dos subarbres
        NodoABB<E> subArbreEsqu = construirEquilibrado(v,ini,meitat -1);
        NodoABB<E> subArbreDret = construirEquilibrado(v,meitat + 1,fin);
        
        //Contruir l'arbre amb els dos subarbres
            //Utilitze este contructor de NodeABB per a que me guarde la talla
        NodoABB<E> node = new NodoABB<E>(v[meitat], subArbreEsqu, subArbreDret);
    ...
    public void reconstruirEquilibrado() {        
        // COMPLETAR
        //Torna tots els elements d'un arbre, ordenats en un array.
        E[] array = toArrayInOrden();
        //Construeix l'arbre amb eixos elements ordenats
