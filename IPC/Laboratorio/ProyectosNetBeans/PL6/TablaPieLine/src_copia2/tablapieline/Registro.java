...
public class Registro {
    ...
    private SimpleStringProperty campoDia;
    private DoubleProperty campoValor1;
    private DoubleProperty campoValor2;

    Registro(String fDia, double fValor1, double fValor2) {
