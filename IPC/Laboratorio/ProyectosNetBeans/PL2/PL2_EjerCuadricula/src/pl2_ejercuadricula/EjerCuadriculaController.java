...
public class EjerCuadriculaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        //Les següents linies son per a que la bola s'ajuste al tamany de la celda.
        circuloAndreu.radiusProperty().bind(Bindings.min( //minim entre la altura partit per 10 o l'ample partit per 10
                Bindings.divide(gridAndreu.widthProperty(), 10), //Dividit per 5 dona el diametre... pero dividit per 10 dona el tamany del radi.
                Bindings.divide(gridAndreu.heightProperty(), 10))
               );
    }    
