...
public class QueueAC<T> implements Queue<T> { 
    ...
    public void enqueue(T e) {
        // TO COMPLETE ...
        //El last es el index del array
        if (size > theArray.length){expandArray();}
        last = increase(last); 
        theArray[last] = e; //last es el index de la ultima posicio. Basicament coloques e en la ultima posicio.
        size++;
    } 
    ...
    public T dequeue() {
        // TO COMPLETE / CHANGE ...
        T aux = theArray[first]; //posicio primera
        theArray[first] = null; // No se gasta size perque es circular. Aleshores tenim que saber si es null.
